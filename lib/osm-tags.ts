...
const MAPA: Record<string, string[]> = {
  ...
  hamburgueria: ['["amenity"="fast_food"]["cuisine"~"burger"]', '["name"~"burger|hamburgueria|burgueria",i]'],
  churrascaria: ['["amenity"="restaurant"]["cuisine"~"barbecue|steak_house"]', '["name"~"churrasc",i]'],
  "restaurante japones": ['["amenity"="restaurant"]["cuisine"~"japanese|sushi"]', '["name"~"sushi|temaki|japa",i]'],
  bar: ['["amenity"="bar"]', '["amenity"="pub"]'],
  "casa noturna": ['["amenity"="nightclub"]'],
  cafeteria: ['["amenity"="cafe"]'],
  cafe: ['["amenity"="cafe"]'],
  padaria: ['["shop"="bakery"]'],
  confeitaria: ['["shop"~"pastry|confectionery"]', '["name"~"confeitar|doceria|bolo",i]'],
  sorveteria: ['["amenity"="ice_cream"]', '["shop"="ice_cream"]', '["name"~"sorvet|gelateria|acai",i]'],
  "loja de acai": ['["name"~"acai",i]'],
  "loja de conveniencia": ['["shop"="convenience"]'],
  adega: ['["shop"~"wine|alcohol"]'],
  "loja de bebidas": ['["shop"="alcohol"]', '["name"~"distribuidora de bebidas|adega",i]'],

  // mercado / alimentos
  mercado: ['["shop"~"supermarket|convenience|grocery"]'],
  supermercado: ['["shop"="supermarket"]'],
  mercearia: ['["shop"~"convenience|grocery"]'],
  hortifruti: ['["shop"="greengrocer"]', '["name"~"hortifruti|frutaria|sacolao",i]'],
  acougue: ['["shop"="butcher"]'],
  peixaria: ['["shop"="seafood"]'],
  "loja de produtos naturais": ['["shop"~"health_food|nutrition_supplements"]', '["name"~"produtos naturais|natural",i]'],
  ...
  "banho e tosa": ['["shop"="pet_grooming"]', '["name"~"banho e tosa|tosa",i]'],

  // beleza e bem-estar
  "salao de beleza": ['["shop"~"beauty|hairdresser"]'],
  cabeleireiro: ['["shop"="hairdresser"]'],
  barbearia: ['["shop"="hairdresser"]', '["name"~"barbear|barber",i]'],
  "estetica": ['["shop"="beauty"]', '["name"~"estetica|estetic",i]'],
  manicure: ['["shop"="beauty"]', '["name"~"manicure|nail|esmalteria",i]'],
  "clinica de estetica": ['["shop"="beauty"]', '["healthcare"="beautician"]'],
  spa: ['["leisure"="spa"]', '["shop"="massage"]'],
  academia: ['["leisure"="fitness_centre"]', '["amenity"="gym"]', '["name"~"academia|fitness|crossfit",i]'],
  "estudio de pilates": ['["leisure"="fitness_centre"]["fitness_station"~"pilates"]', '["name"~"pilates",i]'],
  ...
  laboratorio: ['["healthcare"="laboratory"]', '["name"~"laboratorio|analises clinicas",i]'],
  fisioterapia: ['["healthcare"="physiotherapist"]', '["name"~"fisioterap",i]'],
  psicologo: ['["healthcare"="psychotherapist"]', '["name"~"psicolog",i]'],
  nutricionista: ['["healthcare"="nutrition_counselling"]', '["name"~"nutri",i]'],
  otica: ['["shop"="optician"]'],
  "loja de suplementos": ['["shop"="nutrition_supplements"]', '["name"~"suplement",i]'],

  // automotivo
  "oficina mecanica": ['["shop"="car_repair"]'],
  "auto eletrica": ['["shop"="car_repair"]', '["name"~"auto eletrica|eletrica automotiva",i]'],
  funilaria: ['["shop"="car_repair"]', '["name"~"funilaria|lanternagem|pintura",i]'],
  "lava rapido": ['["amenity"="car_wash"]'],
  "auto center": ['["shop"="car_repair"]', '["shop"="tyres"]'],
  borracharia: ['["shop"="tyres"]', '["name"~"borracharia|pneus",i]'],
  ...
  "agencia de publicidade": ['["office"="advertising_agency"]', '["name"~"publicidade|marketing|agencia",i]'],
  "despachante": ['["office"="government"]', '["name"~"despachante",i]'],
  cartorio: ['["office"="notary"]', '["name"~"cartorio|tabeliao|registro civil",i]'],
  ...
  "assistencia tecnica": ['["shop"~"mobile_phone|electronics|computer"]', '["craft"="electronics_repair"]', '["name"~"assistencia tecnica",i]'],
  ...
  livraria: ['["shop"="books"]'],
  "loja de material de construcao": ['["shop"~"doityourself|hardware|trade"]', '["name"~"material de construcao|construcao",i]'],
  ...
  "armarinho": ['["shop"~"fabric|sewing|haberdashery"]', '["name"~"armarinho|aviamento",i]'],

  // ofícios e serviços
  grafica: ['["shop"="copyshop"]', '["craft"="printer"]', '["name"~"grafica|impressao",i]'],
  vidracaria: ['["craft"="glaziery"]', '["name"~"vidracaria|vidros",i]'],
  marcenaria: ['["craft"="carpenter"]', '["name"~"marcenaria|marceneiro",i]'],
  serralheria: ['["craft"~"blacksmith|metal_construction"]', '["name"~"serralheria|serralheiro",i]'],
  eletricista: ['["craft"="electrician"]'],
  encanador: ['["craft"="plumber"]'],
  chaveiro: ['["shop"="locksmith"]', '["craft"="key_cutter"]', '["name"~"chaveiro",i]'],
  costureira: ['["craft"="tailor"]', '["shop"="tailor"]', '["name"~"costureira|ajuste de roupa|conserto de roupa",i]'],
  lavanderia: ['["shop"="laundry"]'],
  "dedetizadora": ['["craft"="pest_control"]', '["name"~"dedetiza|controle de pragas",i]'],

  // hospedagem
  hotel: ['["tourism"="hotel"]'],
  pousada: ['["tourism"~"guest_house|hotel"]', '["name"~"pousada",i]'],
  motel: ['["tourism"="motel"]', '["name"~"motel",i]'],
  hostel: ['["tourism"="hostel"]'],

  // educação
  escola: ['["amenity"="school"]'],
  "escola de idiomas": ['["amenity"="language_school"]'],
  "escola de musica": ['["amenity"="music_school"]', '["name"~"escola de musica",i]'],
  ...
  "gesso e drywall": ['["craft"="plasterer"]', '["name"~"gesso|drywall|gesseiro",i]'],
  desentupidora: ['["craft"~"plumber|pest_control"]["name"~"desentup",i]', '["name"~"desentupidora|limpa fossa",i]'],
